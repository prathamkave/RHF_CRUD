...
const Form = () => {
	...
	return (
		<div className='flex items-center justify-center h-screen w-full bg-[#24221B] overflow-hidden font-poppins p-4'>
			<div className='w-full max-w-md p-6 bg-[#24221B] rounded-2xl shadow-2xl border border-[#E4DFD8]/15'>
